...
namespace OnlineStore.Migrations
{
    ...
    [Migration("20180818182348_ChangePriceToDec")]
    partial class ChangePriceToDec
    {
            ...
            modelBuilder.Entity("OnlineStore.Data.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, OrderDate = new DateTime(2018, 8, 18, 18, 23, 48, 536, DateTimeKind.Utc), OrderNumber = "12345" }
                    );
                });
